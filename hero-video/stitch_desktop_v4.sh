#!/usr/bin/env bash
# Stitch KarmaKaart desktop hero v4 — responders re-rolled with new phone-scale
...
CLIPS="$HERE/clips"
OUT="$HERE/karmakaart_hero_desktop_v4.mp4"

C1="$CLIPS/shot1_maya_v3.mp4"
C2="$CLIPS/shot2a_marcus_v4.mp4"
C3="$CLIPS/shot2b_lisa_v4.mp4"
C4="$CLIPS/shot2c_jan_v4.mp4"

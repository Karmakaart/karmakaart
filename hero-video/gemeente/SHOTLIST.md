...
| 1a | 8–11s | `clips/shot2b_daan_arrival_anim_v2.mp4` | **Scène 1 — eenzaamheid.** Daan komt **gesloten** aan bij Henks voordeur (aarzeling bij de deur). *(v2 2026-07-24: loopcyclus-fix — echte passen i.p.v. glijden, handen blijven in de zakken.)* |
...
| 1c | 16–19s | `clips/shot3b_daan_leaves_anim_v2.mp4` | Daan loopt **opgeveerd** weg. Op de kaartlaag: **marker 1 grijs → goud**. Optioneel (locked idee): ook **Daans eigen dot** licht label-loos warm op — de participatie-subtext. *(v2 2026-07-24: loopcyclus-fix — verende tred met armzwaai.)* |
...
- `keyframes/shot2b_daan_arrival_v1.png` + `clips/shot2b_daan_arrival_anim_v2.mp4` — beat 1a (aankomst, gesloten; v1 = houterige loop, vervangen)
- `keyframes/shot3_daan_henk_koffie_v1.png` + `clips/shot3_daan_henk_koffie_v2.mp4` — beat 1b (**v2 gebruiken**)
- `keyframes/shot3b_daan_leaves_v1.png` + `clips/shot3b_daan_leaves_anim_v2.mp4` — beat 1c (afscheid, opgeveerd; v1 = houterige loop, vervangen)
...
## Rough cut / animatic (ffmpeg) — `gemeente_roughcut_v5.mp4`
